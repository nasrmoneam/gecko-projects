...
// BZ2_crc32Table from bzip2 is stil used so the patches generated by bsdiff
// when using lzma compression for mar files are the same as the patches
// generated by bsdiff when using bzip2 compression for mar files.
#include "crctable.c"
