...
config = {
    ...
    # TODO: use real repo
    "repo": {
        "repo": "https://hg.mozilla.org/users/raliiev_mozilla.com/tools-fake",
        "branch": "default",
        "dest": "tools",
        "vcs": "hg",
    },
    ...
    # TODO: use real repo
    "push_dest": "ssh://hg.mozilla.org/users/raliiev_mozilla.com/tools-fake",
    ...
    "balrog_url": "http://ec2-54-159-98-221.compute-1.amazonaws.com:9090",
