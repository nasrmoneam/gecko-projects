...
/**
 * Sets a preference's value in a way that it is remembered and can be set
...
/**
 * Pops all prefs which have been pushed with pushPref.
 */
function popPrefs() {
...
/**
 * Resets the preference with the provided name to the value before pushPref
 * was called.
 *
 * @param  name
 *         The name of the preference.
