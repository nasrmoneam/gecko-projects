...
function processStep({notificationId, button, beforeClick, cleanup}) {
  return Task.spawn(function*() {
    ...
    yield waitForEventOnTarget(PanelUI.notificationPanel, "popupshown");
...
/**
 * Waits for the specified event on the specified target.
 * @param  target
 *         An EventTarget to listen for the event on.
 * @param  eventName
